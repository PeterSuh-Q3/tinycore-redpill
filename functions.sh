...
menuentry 'Mount Syno BTRFS Vol Rescue (with Alpine 3.8)' {
        ...
        linux /alpine_3.8/vmlinuz-4.14 loglevel=3 modules=md_mod,dm_mod,btrfs,raid6_pq,scsi_mod,sd_mod,sg,sr_mod,libata,ahci,nvme_core,nvme,usb_storage,uas,igc,e1000e,e1000,igb,ixgbe,r8169,r8152,tg3,bnx2,atlantic,alx,sky2,skge
