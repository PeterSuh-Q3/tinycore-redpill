...
function get_tinycore9() {
    ...
    if [ ${md5_corepure64} = "3ec614287ca178d6c6f36887504716e4" ] && [ ${md5_vmlinuz64} = "9ad7991ef3bc49c4546741b91fc36443" ]; then
      ...
      sudo curl -kL# https://raw.githubusercontent.com/PeterSuh-Q3/tinycore-redpill/master/mountvol.sh -o /home/tc/mountvol.sh
      echo '[ $(uname -r | grep 4.14.10 | wc -l) -eq 1 ] && /home/tc/mountvol.sh' >> /opt/bootlocal.sh
