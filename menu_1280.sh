...
#fi  
    ...
    if [ -f /tmp/test_mode ]; then
      ...
      curl -kL https://raw.githubusercontent.com/PeterSuh-Q3/tinycore-redpill/master/functions_${oldver}.sh -o functions.sh
      curl -kL https://raw.githubusercontent.com/PeterSuh-Q3/tinycore-redpill/master/menu_m_${oldver}.sh -o menu_m.sh
