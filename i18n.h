...
MSGZZ177=$(gettext "tcrp" "Enter the static network settings for %s\n\nThe gateway may be left blank if this is not the primary NIC. This only works correctly if this NIC shares the primary NIC's subnet - otherwise this NIC will only reach hosts on its own local subnet.")
MSGZZ178=$(gettext "tcrp" "Manage %s")
MSGZZ179=$(gettext "tcrp" "none")
MSGZZ180=$(gettext "tcrp" "DNS")
MSGZZ181=$(gettext "tcrp" "Set the DNS server used by all static NICs (required once any NIC is configured).\n\nExample: 8.8.8.8")
...
MSGZZ199=$(gettext "tcrp" "Deep-learning acceleration: use an NVIDIA RTX 2000 Ada or RTX PRO 2000 Blackwell-class discrete GPU")
...
MSGZZ192=$(gettext "tcrp" "Configuration saved and applied now.\n\nNo loader rebuild is required.")
MSGZZ193=$(gettext "tcrp" "Configuration saved and synchronized.\n\nNo loader rebuild is required.\nIt will be applied on the next FRIEND to DSM boot.")
MSGZZ194=$(gettext "tcrp" "Configuration saved.\n\nNo loader rebuild is required.\nIt will be used by the next related action.")
MSGZZ195=$(gettext "tcrp" "Configuration saved.\n\nRebuild the loader to include this change in the next boot.")
