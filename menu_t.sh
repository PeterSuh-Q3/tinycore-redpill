...
if [ "${offline}" = "NO" ]; then
    curl -skLO# https://raw.githubusercontent.com/PeterSuh-Q3/tinycore-redpill/alpine-redpill/models.json
    if [ -f /tmp/test_mode ]; then
      cecho g "###############################  This is Test Mode  ############################"
      curl -skL# https://raw.githubusercontent.com/PeterSuh-Q3/tinycore-redpill/alpine-redpill/functions_t.sh -o functions.sh
      curl -skLO# https://raw.githubusercontent.com/PeterSuh-Q3/tinycore-redpill/alpine-redpill/menu_m.sh
    ...
    #else
    #  curl -skLO# https://raw.githubusercontent.com/PeterSuh-Q3/tinycore-redpill/alpine-redpill/functions.sh
    fi
