...
kver5explatforms="epyc7002(DT) icelaked(DT) v1000nk(DT) r1000nk(DT) geminilakenk(DT)"
...
function modelMenu() {
  ...
  M_GRP1="epyc7002 icelaked v1000nk r1000nk geminilakenk broadwellnk"
  ...
  if [[ "${platform}" == "epyc7002(DT)" || "${platform}" == "icelaked(DT)" || "${platform}" == "geminilakenk(DT)" || "${platform}" == "v1000nk(DT)" || "${platform}" == "r1000nk(DT)" ]]; then
...
function additional() {
  ...
  while true; do
    ...
    [ "$FRKRNL" = "NO" ] && [ "${platform}" != "epyc7002(DT)" ] && [ "${platform}" != "icelaked(DT)" ] && eval "echo \"h \\\"${MSG61}${SHR_EX_TEXT}\\\"\"" >> "${TMP_PATH}/menua"
    [ "$FRKRNL" = "NO" ] && [ "${platform}" != "epyc7002(DT)" ] && [ "${platform}" != "icelaked(DT)" ] && eval "echo \"m \\\"${MSG62}\\\"\"" >> "${TMP_PATH}/menua"
